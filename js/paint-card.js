function paintCard(givenCard){
  ...
  var cardSuitColor = givenCard.suit === "diamonds" || givenCard.suit === "hearts" ? "red" : "black";
  cardSuit.setAttribute("stroke", cardSuitColor);
  cardSuit.setAttribute("fill", cardSuitColor);
  ...
  cardFace.textContent = String(givenCard.cardFace).slice(0,1);
  cardFace.setAttribute("stroke", cardSuitColor);
  cardFace.setAttribute("x", "3");

  cardFace.setAttribute("y", "12");
